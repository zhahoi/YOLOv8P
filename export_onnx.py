...
if __name__ == "__main__":
    ...
    model = MCnet(YOLOP)
    checkpoint = torch.load('C:/Github/YOLOP/tools/runs/BddDataset/checkpoint.pth', map_location=device)
    ...
    onnx_path = f'./weights/yolov8p-{height}-{width}.onnx'
    ...
    torch.onnx.export(model, inputs, onnx_path,
                      ...
                      output_names=['det_stride_8', 'det_stride_16', 'det_stride_32', 'drive_area_seg', 'lane_line_seg'])
