...
_C.MODEL.HEADS_NAME = ['']
_C.MODEL.PRETRAINED = "tools/runs/BddDataset/checkpoint.pth"
...
_C.DATASET.DATAROOT = 'C:/Dataset/bdd100k/bdd100k/images'       # the path of images folder
_C.DATASET.LABELROOT = 'C:/Dataset/bdd100k/bdd100k/det_annotations'      # the path of det_annotations folder
_C.DATASET.MASKROOT = 'C:/Dataset/bdd100k/bdd100k/da_seg_annotations'                # the path of da_seg_annotations folder
_C.DATASET.LANEROOT = 'C:/Dataset/bdd100k/bdd100k/ll_seg_annotations'               # the path of ll_seg_annotations folder
...
_C.TRAIN.END_EPOCH = 200 # 240

_C.TRAIN.VAL_FREQ = 1
_C.TRAIN.BATCH_SIZE_PER_GPU = 16 #24
...
_C.TEST.BATCH_SIZE_PER_GPU = 8 # 24
_C.TEST.MODEL_FILE = ''
_C.TEST.SAVE_JSON = False
_C.TEST.SAVE_TXT = False
_C.TEST.PLOTS = True
_C.TEST.NMS_CONF_THRESHOLD  = 0.5
_C.TEST.NMS_IOU_THRESHOLD  = 0.2
...
def update_config(cfg, args):
    ...
    # cfg.MODEL.PRETRAINED = "C:/Github/YOLOP/tools/runs/BddDataset/checkpoint.pth"
